...
using Practical19_AdvanceMVC.Models;

namespace Practical19_AdvanceMVC.Views
{
    public class CourseAssignmentsMarkingsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.MarkerID = new SelectList(db.Staffs, "ID", "Title");
        ...
        public ActionResult Create([Bind(Include = "ID,CourseID,MarkerID,StudentID")] CourseAssignmentsMarking courseAssignmentsMarking)
        {
            ...
            ViewBag.MarkerID = new SelectList(db.Staffs, "ID", "Title", courseAssignmentsMarking.MarkerID);
